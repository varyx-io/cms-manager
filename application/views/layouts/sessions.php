...
<html lang="en">
	<head>
		...
		<link href="<?php echo base_url('ux/libs/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css'); ?>" rel="stylesheet">
  ...
  <body class="solid_dark">
    ...
    <script src="<?php echo base_url('ux/js/demo.js'); ?>"></script>
  </body>
</html>
