	...
	<body class="">
		...
		<header id="header">
			<div id="logo-group">
				...
				<span id="logo"> <img src="<?php echo base_url('ux/assets/images/logos/varyx-logo.png'); ?>" alt="varyx | io"> </span>
			...
			<div class="project-context hidden-xs">
				...
				<span class="project-selector dropdown-toggle" data-toggle="dropdown">API Keys <i class="fa fa-angle-down"></i></span>
				...
				<ul class="dropdown-menu">
					...
					<li>
						<a href="javascript:void(0);">site.net</a>
					</li>
					<li>
						<a href="javascript:void(0);">oogled.com</a>
					</li>
					<li class="divider"></li>
					<li>
						<a href="javascript:void(0);"><i class="fa fa-key"></i> Manage Keys</a>
					</li>
				</ul>
				<!-- end dropdown-menu-->
