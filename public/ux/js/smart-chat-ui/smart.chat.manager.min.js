var chatboxManager = function() {
    var a = function(a) {
        ...
        var g = showList.indexOf(a), h = boxList.indexOf(a);
        if (-1 != g) ; else if (-1 != h) {
...
$("a[data-chat-id]:not(.offline)").click(function(a, b) {
    var c = $(this), d = c.attr("data-chat-id"), e = c.attr("data-chat-fname"), f = c.attr("data-chat-lname"), g = c.attr("data-chat-status") || "online", h = c.attr("data-chat-alertmsg"), i = c.attr("data-chat-alertshow") || !1;
