...
SpeechRecognition && voice_command) {
    $.root_.on("click", '[data-action="voiceCommand"]', function(a) {
        ...
        $("#speech-btn .popover").fadeIn(350)), a.preventDefault();
    ...
    modal.appendTo("body"), debugState && root.console.log("This browser supports Voice Command"), 
    $.speechApp = function(a) {
        return a.start = function() {
            smartSpeechRecognition.addCommands(commands), smartSpeechRecognition ? (smartSpeechRecognition.start(), 
            $.root_.addClass("voice-command-active"), $.speechApp.playON(), voice_localStorage && localStorage.setItem("sm-setautovoice", "true")) : alert("speech plugin not loaded");
        }, a.stop = function() {
            smartSpeechRecognition && (smartSpeechRecognition.abort(), $.root_.removeClass("voice-command-active"), 
            $.speechApp.playOFF(), voice_localStorage && localStorage.setItem("sm-setautovoice", "false"), 
            ...
            $.get(), a.addEventListener("load", function() {
                a.play();
            }, !0), $.sound_on && (a.pause(), a.play());
...
(function(a) {
    ...
    root.smartSpeechRecognition = {
        init: function(g, h) {
            h = h === a ? !0 : !!h, b && b.abort && b.abort(), b = new SpeechRecognition(), 
            b.maxAlternatives = 5, b.continuous = !0, b.lang = voice_command_lang || "en-US", 
            b.onstart = function() {
                m(e.start), debugState && (root.console.log("%c ✔ SUCCESS: User allowed access the microphone service to start ", debugStyle_success), 
                root.console.log("Language setting is set to: " + b.lang, debugStyle)), $.root_.removeClass("service-not-allowed"), 
                ...
                switch (m(e.error), a.error) {
                  ...
                  case "service-not-allowed":
                    c = !1, $.root_.removeClass("service-allowed"), $.root_.addClass("service-not-allowed"), 
                ...
                for (var b, c = a.results[a.resultIndex], f = 0; f < c.length; f++) {
                    ...
                    for (var g = 0, h = d.length; h > g; g++) {
                        ...
                        if (i) {
                            ...
                            j.length && root.console.log("with parameters", j)), d[g].callback.apply(this, j), 
                            m(e.resultMatch);
        ...
        start: function(d) {
            n(), d = d || {}, c = d.autoRestart !== a ? !!d.autoRestart : !0, f = new Date().getTime(), 
            b.start();
        },
        abort: function() {
            c = !1, o && b.abort();
...
var autoStart = function() {
    smartSpeechRecognition.addCommands(commands), smartSpeechRecognition ? (smartSpeechRecognition.start(), 
    $.root_.addClass("voice-command-active"), voice_localStorage && localStorage.setItem("sm-setautovoice", "true")) : alert("speech plugin not loaded");
};
