!function(a) {
    ...
    function c(c, e, f, g) {
        ...
        function j(b) {
            ...
            for (f = ea.xaxes.length || 1, d = 0; f > d; ++d) e = ea.xaxes[d], e && !e.tickColor && (e.tickColor = e.color), 
            ...
            for (f = ea.yaxes.length || 1, d = 0; f > d; ++d) e = ea.yaxes[d], e && !e.tickColor && (e.tickColor = e.color), 
        ...
        function r() {
            ...
            for (b = 0; c > b; b++) f = a.color.parse(h[b % i] || "#666"), b % i == 0 && b && (j = j >= 0 ? .5 > j ? -j - .2 : 0 : -j), 
            g[b] = f.scale("rgb", 1 + j);
            var k, l = 0;
            for (b = 0; b < da.length; ++b) {
        ...
        function s() {
            ...
            for (c = 0; c < da.length; ++c) {
                ...
                if (null == g.datapoints.pointsize) {
                    ...
                    for (g.xaxis.used = g.yaxis.used = !0, d = e = 0; d < o.length; ++d, e += j) {
                        m = o[d];
                        var v = null == m;
                        if (!v) for (f = 0; j > f; ++f) k = m[f], l = p[f], l && (l.number && null != k && (k = +k, 
                        isNaN(k) ? k = null : k == 1 / 0 ? k = s : k == -(1 / 0) && (k = -s)), null == k && (l.required && (v = !0), 
                        null != l.defaultValue && (k = l.defaultValue))), i[e + f] = k;
                        if (v) for (f = 0; j > f; ++f) k = i[e + f], null != k && (l = p[f], l.autoscale !== !1 && (l.x && b(g.xaxis, k, k), 
            ...
            for (c = 0; c < da.length; ++c) {
                ...
                l = p[f], l && l.autoscale !== !1 && k != s && k != -s && (l.x && (w > k && (w = k), 
                k > y && (y = k)), l.y && (x > k && (x = k), k > z && (z = k)));
                if (g.bars.show) {
                    var A;
                    switch (g.bars.align) {
                      case "left":
        ...
        function C(a) {
            ...
            if (0 == e) {
                ...
                null != g && (null == b.min && (c -= e * g, 0 > c && null != a.datamin && a.datamin >= 0 && (c = 0)), 
        ...
        function D(b) {
            ...
            if (1.5 > k ? i = 1 : 3 > k ? (i = 2, k > 2.25 && (null == h || h >= g + 1) && (i = 2.5, 
            ++g)) : i = 7.5 > k ? 5 : 10, i *= j, null != e.minTickSize && i < e.minTickSize && (i = e.minTickSize), 
                ...
                for (var d = a.points, e = a.pointsize, f = Math.min(Math.max(0, c.min), c.max), g = 0, h = !1, i = 1, j = 0, k = 0; ;) {
                    ...
                    if (null != l && null != n) {
                        ...
                        ia.lineTo(b.p2c(n), c.p2c(c.min)); else {
                            var p = l, q = n;
                            o >= m && m < c.min && o >= c.min ? (l = (c.min - m) / (o - m) * (n - l) + l, m = c.min) : m >= o && o < c.min && m >= c.min && (n = (c.min - m) / (o - m) * (n - l) + l, 
        ...
        function O(a, b, c, d, e, f, g, h, i, j, k) {
            ...
            j ? (s = q = r = !0, p = !1, l = c, m = a, o = b + d, n = b + e, l > m && (t = m, 
            m = l, l = t, p = !0, q = !1)) : (p = q = r = !0, s = !1, l = a + d, m = a + e, 
            n = c, o = b, n > o && (t = o, o = n, n = t, s = !0, r = !1)), m < g.min || l > g.max || o < h.min || n > h.max || (l < g.min && (l = g.min, 
        ...
        function R() {
            ...
            ea.legend.show) {
                ...
                for (var i = 0; i < f.length; ++i) {
                    ...
                    e.push('<td class="legendColorBox"><div style="' + ea.legend.labelBoxBorderColor + '"><div style="border:2px solid ' + k.color + ';overflow:hidden"></div></div></td><td class="legendLabel"><span>' + k.label + "</span></td>");
                }
