!function(a) {
    ...
    b.prototype = {
        ...
        setColor: function(b) {
            ...
            a.each(d.stringParsers, function(a, e) {
                ...
                return g ? ("hsla" === h ? c.value = d.RGBtoHSB.apply(null, d.HSLtoRGB.apply(null, g)) : c.value = d.RGBtoHSB.apply(null, g), 
                !1) : void 0;
            });
        },
        setHue: function(a) {
    ...
    var c = function(b, c) {
        ...
        this.format = d.translateFormats[e], this.isInput = this.element.is("input"), this.component = this.element.is(".color") ? this.element.find(".add-on") : !1, 
    ...
    c.prototype = {
        ...
        show: function(b) {
            ...
            this.place(), a(window).on("resize", a.proxy(this.place, this)), this.isInput || b && (b.stopPropagation(), 
            b.preventDefault()), a(document).on({
        ...
        setValue: function(a) {
            ...
            this.previewColor(), this.element.trigger({
                type: "changeColor",
                color: this.color
            });
        },
        hide: function() {
            ...
            this.element.data("color", this.format.call(this))), this.element.trigger({
                type: "hide",
                color: this.color
            });
        },
        ...
        mousedown: function(b) {
            ...
            if (!e.is(".colorpicker")) {
                ...
                var f = e.offset();
                this.slider.knob = e.find("i")[0].style, this.slider.left = b.pageX - f.left, this.slider.top = b.pageY - f.top, 
                this.pointer = {
                    left: b.pageX,
                    top: b.pageY
                }, a(document).on({
        ...
        mousemove: function(a) {
            ...
            return this.slider.knob.left = b + "px", this.slider.knob.top = c + "px", this.slider.callLeft && this.color[this.slider.callLeft].call(this.color, b / 100), 
