!function(a) {
    ...
    function c(b, c) {
        this.$select = a(b), this.options = this.mergeOptions(a.extend({}, c, this.$select.data())), 
    ...
    "undefined" != typeof ko && ko.bindingHandlers && !ko.bindingHandlers.multiselect && (ko.bindingHandlers.multiselect = {
        ...
        defaults: {
            buttonText: function(b, c) {
                ...
                if (this.allSelectedText && b.length == a("option", a(c)).length) return this.selectAllNumber ? this.allSelectedText + " (" + b.length + ")" : this.allSelectedText;
        ...
        select: function(b, c) {
            ...
            for (var d = 0; d < b.length; d++) {
                ...
                if (null !== e && void 0 !== e) {
                    ...
                    g.prop("checked", !0), f.prop("selected", !0));
                }
            }
        ...
        deselect: function(b, c) {
            ...
            for (var d = 0; d < b.length; d++) {
                ...
                if (null !== e && void 0 !== e) {
                    ...
                    g.prop("checked", !1), f.prop("selected", !1));
                }
            }
