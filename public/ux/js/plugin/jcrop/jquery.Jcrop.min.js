!function(a) {
    a.Jcrop = function(b, c) {
        ...
        function n(a) {
            return function(b) {
                return J.disabled ? !1 : "move" !== a || J.allowMove ? (I = g(R), da = !0, j(a, h(b)), 
        ...
        function o(a, b, c) {
            ...
            d = c / a.height() * a.width()), ba = a.width() / d, ca = a.height() / e, a.width(d).height(e);
        }
        function p(a) {
            return {
                x: a.x * ba,
        ...
        function q(a) {
            var b = la.getFixed();
            b.w > J.minSelect[0] && b.h > J.minSelect[1] ? (na.enableHandles(), na.done()) : na.release(), 
        ...
        function r(a) {
            ...
            var b = h(a);
            return la.setPressed(b), na.update(), oa.activateHandlers(s, q, "touch" === a.type.substring(0, 5)), 
            pa.watchKeys(), a.stopPropagation(), a.preventDefault(), !1;
        }
        function s(a) {
            ...
            if (!ea) {
                ...
                var s = function() {
                    return function() {
                        ...
                        100 > q ? (x(k), c()) : (na.done(), na.animMode(!1), "function" == typeof b && b.call(qa));
                    };
                }();
                c();
            }
        ...
        function w(a) {
            x([ a[0] / ba, a[1] / ca, a[2] / ba, a[3] / ca ]), J.onSelect.call(qa, p(la.getFixed())), 
            na.enableHandles();
        }
        function x(a) {
        ...
        function F(a, b) {
            ...
            c.onload = function() {
                ...
                T = R.height(), V.width(S).height(T), ha.width(S + 2 * ga).height(T + 2 * ga), U.width(S).height(T), 
                ma.resize(S, T), C(), "function" == typeof b && b.call(qa);
            }, c.src = a;
        }
        function G(a, b, c) {
            var d = b || J.bgColor;
        ...
        function H(a) {
            ...
            oa.setCursor(J.allowSelect ? "crosshair" : "default"), na.setCursor(J.allowMove ? "move" : "default"), 
            J.hasOwnProperty("trueSize") && (ba = J.trueSize[0] / S, ca = J.trueSize[1] / T), 
            J.hasOwnProperty("setSelect") && (w(J.setSelect), na.done(), delete J.setSelect), 
            ma.refresh(), J.bgColor != ia && (G(J.shade ? ma.getShades() : U, J.shade ? J.shadeColor || J.bgColor : J.bgColor), 
            ia = J.bgColor), ja != J.bgOpacity && (ja = J.bgOpacity, J.shade ? ma.refresh() : na.setBgOpacity(ja)), 
            Z = J.maxSize[0] || 0, $ = J.maxSize[1] || 0, _ = J.minSize[0] || 0, aa = J.minSize[1] || 0, 
        ...
        var ka = function() {
            ...
            return {
                createDragger: function(a) {
                    return function(b) {
                        return J.disabled ? !1 : "move" !== a || J.allowMove ? (I = g(R), da = !0, j(a, h(ka.cfilter(b)), !0), 
                        b.stopPropagation(), b.preventDefault(), !1) : !1;
                    };
                },
            ...
            function i() {
                ...
                aa / ca && Math.abs(c) < aa / ca && (p = c > 0 ? n + aa / ca : n - aa / ca), _ / ba && Math.abs(b) < _ / ba && (o = b > 0 ? m + _ / ba : m - _ / ba), 
            ...
            function g() {
                m || (m = !0, n.insertBefore(R), c(), na.setBgOpacity(1, 0, 1), V.hide(), h(J.shadeColor || J.bgColor, 1), 
            ...
            function i() {
                m && (n.remove(), V.show(), m = !1, na.isAwake() ? na.setBgOpacity(J.bgOpacity, 1, 1) : (na.setBgOpacity(1, 1, 1), 
                na.disableHandles()), G(U, 0, 1));
            }
            function j(a, b) {
            ...
            function c(b, c) {
                ...
                return ka.support && d.bind("touchstart.jcrop", ka.createDragger(b)), X.append(d), 
                d;
            }
            function f(a) {
            ...
            return ka.support && G.bind("touchstart.jcrop", ka.createDragger("move")), W.append(G), 
            x(), {
                updateVisible: o,
                update: q,
                release: u,
            ...
            function e(a) {
                return a.preventDefault(), a.stopPropagation(), da && (da = !1, l(h(a)), na.isAwake() && J.onSelect.call(qa, p(la.getFixed())), 
            ...
            return m || ha.mousemove(d).mouseup(e).mouseout(e), R.before(ha), {
                activateHandlers: f,
                setCursor: j
            };
        }(), pa = function() {
            ...
            function d(a, b, c) {
                J.allowMove && (la.moveOffset([ b, c ]), na.updateVisible(!0)), a.preventDefault(), 
                a.stopPropagation();
            }
            function e(a) {
