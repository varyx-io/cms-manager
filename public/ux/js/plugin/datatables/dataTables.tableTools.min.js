    ...
    var d = function(d, e) {
        ...
        var f = {
            ...
            getDOMObjectPosition: function(a) {
                ...
                b.top += a.offsetTop, a = a.offsetParent;
                return b;
            },
            Client: function(a) {
                this.handlers = {}, this.id = f.nextId++, this.movieId = "ZeroClipboard_TableToolsMovie_" + this.id, 
                f.register(this.id, this), a && this.glue(a);
            }
        };
        return f.Client.prototype = {
            ...
            glue: function(a, c) {
                ...
                g.position = "absolute", g.left = "0px", g.top = "0px", g.width = e.width + "px", 
                g.height = e.height + "px", g.zIndex = d, "undefined" != typeof c && "" !== c && (this.div.title = c), 
                0 !== e.width && 0 !== e.height && (this.sized = !0), this.domElement && (this.domElement.appendChild(this.div), 
            ...
            positionElement: function() {
                ...
                if (b.position = "absolute", b.width = a.width + "px", b.height = a.height + "px", 
            ...
            addEventListener: function(a, b) {
                a = a.toString().toLowerCase().replace(/^on/, ""), this.handlers[a] || (this.handlers[a] = []), 
            ...
            receiveEvent: function(c, d) {
                ...
                switch (c = c.toString().toLowerCase().replace(/^on/, "")) {
                  case "load":
                    ...
                    this.ready = !0, this.movie.clearText(), this.movie.appendText(this.clipText), this.movie.setFileName(this.fileName), 
                    this.movie.setAction(this.action), this.movie.setCharSet(this.charSet), this.movie.setBomInc(this.incBom), 
            ...
            TableTools = function(b, c) {
                ...
                }, this.classes = a.extend(!0, {}, TableTools.classes), this.s.dt.bJUI && a.extend(!0, this.classes, TableTools.classes_themeroller), 
                this.fnSettings = function() {
                    return this.s;
                }, "undefined" == typeof c && (c = {}), TableTools._aInstances.push(this), this._fnConstruct(c), 
                this;
            }, TableTools.prototype = {
                fnGetSelected: function(a) {
                    var b, c, d = [], e = this.s.dt.aoData, f = this.s.dt.aiDisplay;
                    if (a) for (b = 0, c = f.length; c > b; b++) e[f[b]]._DTTT_selected && d.push(e[f[b]].nTr); else for (b = 0, 
                    c = e.length; c > b; b++) e[b]._DTTT_selected && d.push(e[b].nTr);
                    return d;
                },
                ...
                fnGetSelectedIndexes: function(a) {
                    var b, c, d = [], e = this.s.dt.aoData, f = this.s.dt.aiDisplay;
                    if (a) for (b = 0, c = f.length; c > b; b++) e[f[b]]._DTTT_selected && d.push(f[b]); else for (b = 0, 
                    c = e.length; c > b; b++) e[b]._DTTT_selected && d.push(b);
                    return d;
                },
                ...
                fnCalcColRatios: function(a) {
                    ...
                    for (b = 0, c = e.length; c > b; b++) e[b] && (g = d[b].nTh.offsetWidth, h += g, 
                    f.push(g));
                ...
                _fnConstruct: function(b) {
                    var c = this;
                    this._fnCustomiseSettings(b), this.dom.container = d.createElement(this.s.tags.container), 
                    this.dom.container.className = this.classes.container, "none" != this.s.select.type && this._fnRowSelectConfig(), 
                    this._fnButtonDefinations(this.s.buttonSet, this.dom.container), this.s.dt.aoDestroyCallback.push({
                        sName: "TableTools",
                        fn: function() {
                            a(c.s.dt.nTBody).off("click.DTTT_Select", c.s.custom.sRowSelector).off("mousedown.DTTT_Select", "tr").off("mouseup.DTTT_Select", "tr"), 
                ...
                _fnCustomiseSettings: function(b) {
                    ...
                    this.dom.table = this.s.dt.nTable, this.s.custom = a.extend({}, TableTools.DEFAULTS, b), 
                    this.s.swfPath = this.s.custom.sSwfPath, "undefined" != typeof f && (f.moviePath = this.s.swfPath), 
                ...
                _fnCreateButton: function(b, c) {
                    ...
                    } else "text" == b.sAction ? this._fnTextConfig(d, b) : "div" == b.sAction ? this._fnTextConfig(d, b) : "collection" == b.sAction && (this._fnTextConfig(d, b), 
                    this._fnCollectionConfig(d, b));
                ...
                _fnButtonBase: function(a, b) {
                    ...
                    return g.className = f + " " + a.sButtonClass, g.setAttribute("id", "ToolTables_" + this.s.dt.sInstance + "_" + i.buttonCounter), 
                    g.appendChild(h), h.innerHTML = a.sButtonText, i.buttonCounter++, g;
                },
                ...
                _fnCollectionConfig: function(a, b) {
                    ...
                    c.style.display = "none", c.className = this.classes.collection.container, b._collection = c, 
                    d.body.appendChild(c), this._fnButtonDefinations(b.aButtons, c);
                },
                _fnCollectionShow: function(c, e) {
                    ...
                    h.style.position = "absolute", h.style.left = i + "px", h.style.top = j + "px", 
                    h.style.display = "block", a(h).css("opacity", 0);
                    var o = d.createElement("div");
                    o.style.position = "absolute", o.style.left = "0px", o.style.top = "0px", o.style.height = (k > l ? k : l) + "px", 
                    o.style.width = (m > n ? m : n) + "px", o.className = this.classes.collection.background, 
                    a(o).css("opacity", 0), d.body.appendChild(o), d.body.appendChild(h);
                    var p = a(h).outerWidth(), q = a(h).outerHeight();
                    i + p > n && (h.style.left = n - p + "px"), j + q > l && (h.style.top = j - q - a(c).outerHeight() + "px"), 
                    this.dom.collection.collection = h, this.dom.collection.background = o, setTimeout(function() {
                        a(h).animate({
                            opacity: 1
                        }, 500), a(o).animate({
                            opacity: .25
                    ...
                    if (this.s.master) {
                        ...
                        a(c.nTable).addClass(this.classes.select.table), "os" === this.s.select.type && (a(c.nTBody).on("mousedown.DTTT_Select", "tr", function(b) {
                            ...
                            if (e.parentNode == c.nTBody && null !== c.oInstance.fnGetData(e)) {
                                ...
                                } else b.fnIsSelected(e) && 1 === b.fnGetSelected().length ? b._fnRowDeselect(e, d) : (b.fnSelectNone(), 
                                b._fnRowSelect(e, d)); else b.fnIsSelected(e) ? b._fnRowDeselect(e, d) : "single" == f.type ? (b.fnSelectNone(), 
                                b._fnRowSelect(e, d)) : "multi" == f.type && b._fnRowSelect(e, d);
                                f.lastRow = g;
                            }
                ...
                _fnRowSelect: function(b, c) {
                    ...
                    if (null === this.s.select.preRowSelect || this.s.select.preRowSelect.call(this, c, h, !0)) {
                        ...
                        null !== this.s.select.postSelected && this.s.select.postSelected.call(this, h), 
                ...
                _fnRowDeselect: function(b, c) {
                    ...
                    if (null === this.s.select.preRowSelect || this.s.select.preRowSelect.call(this, c, h, !1)) {
                        ...
                        null !== this.s.select.postDeselected && this.s.select.postDeselected.call(this, h), 
                ...
                _fnSelectData: function(a) {
                    ...
                    if (a.nodeName) b = this.s.dt.oInstance.fnGetPosition(a), e.push(this.s.dt.aoData[b]); else {
                        if ("undefined" != typeof a.length) {
                            for (c = 0, d = a.length; d > c; c++) a[c].nodeName ? (b = this.s.dt.oInstance.fnGetPosition(a[c]), 
                            e.push(this.s.dt.aoData[b])) : "number" == typeof a[c] ? e.push(this.s.dt.aoData[a[c]]) : e.push(a[c]);
                            return e;
                        }
                ...
                _fnTextConfig: function(b, c) {
                    var d = this;
                    null !== c.fnInit && c.fnInit.call(this, b, c), "" !== c.sToolTip && (b.title = c.sToolTip), 
                    a(b).hover(function() {
                        ...
                        null !== c.fnClick && c.fnClick.call(d, b, c, null, a), null !== c.fnComplete && c.fnComplete.call(d, b, c, null, null), 
                ...
                _fnFlashConfig: function(a, b) {
                    ...
                    null !== b.fnInit && b.fnInit.call(this, a, b), d.setHandCursor(!0), "flash_save" == b.sAction ? (d.setAction("save"), 
                    d.setCharSet("utf16le" == b.sCharSet ? "UTF16LE" : "UTF8"), d.setBomInc(b.bBomInc), 
                ...
                _fnColumnTargets: function(b) {
                    ...
                    } else if ("visible" == b) for (c = 0, d = h; d > c; c++) e.push(g[c].bVisible ? !0 : !1); else if ("hidden" == b) for (c = 0, 
                    d = h; d > c; c++) e.push(g[c].bVisible ? !1 : !0); else if ("sortable" == b) for (c = 0, 
                    d = h; d > c; c++) e.push(g[c].bSortable ? !0 : !1); else for (c = 0, d = h; d > c; c++) e.push(!0);
                    return e;
                },
                ...
                _fnGetDataTablesData: function(b) {
                    ...
                    if (b.bHeader) {
                        ...
                        l = this._fnHtmlDecode(l), h.push(this._fnBoundData(l, b.sFieldBoundary, n)));
                    ...
                    for (p = "none" !== this.s.select.type && p && 0 !== r.length, q = p ? r : e.Api ? new e.Api(m).rows(b.oSelectorOpts).indexes().flatten().toArray() : m.oInstance.$("tr", b.oSelectorOpts).map(function(a, b) {
                        ...
                        for (j = m.aoData[q[f]].nTr, h = [], c = 0, d = m.aoColumns.length; d > c; c++) if (o[c]) {
                            ...
                            l = l.replace(/<img.*?\s+alt\s*=\s*(?:"([^"]+)"|'([^']+)'|([^\s>]+)).*?>/gi, "$1$2$3"), 
                            l = l.replace(/<.*?>/g, "")) : l = s + "", l = l.replace(/^\s+/, "").replace(/\s+$/, ""), 
                            l = this._fnHtmlDecode(l), h.push(this._fnBoundData(l, b.sFieldBoundary, n));
                        }
                        k.push(h.join(b.sFieldSeperator)), b.bOpenRows && (i = a.grep(m.aoOpenRows, function(a) {
                            return a.nParent === j;
                        }), 1 === i.length && (l = this._fnBoundData(a("td", i[0].nTr).html(), b.sFieldBoundary, n), 
                        k.push(l)));
                    }
                ...
                _fnHtmlDecode: function(a) {
                    ...
                    return a.replace(/&([^\s]*?);/g, function(a, c) {
                        return "#" === a.substr(1, 1) ? String.fromCharCode(Number(c.substr(1))) : (b.innerHTML = a, 
                        b.childNodes[0].nodeValue);
                    });
                },
                _fnPrintStart: function(c) {
                    var e = this, f = this.s.dt;
                    this._fnPrintHideNodes(f.nTable), this.s.print.saveStart = f._iDisplayStart, this.s.print.saveLength = f._iDisplayLength, 
                    c.bShowAll && (f._iDisplayStart = 0, f._iDisplayLength = -1, f.oApi._fnCalculateEnd && f.oApi._fnCalculateEnd(f), 
                    f.oApi._fnDraw(f)), ("" !== f.oScroll.sX || "" !== f.oScroll.sY) && (this._fnPrintScrollStart(f), 
                    ...
                    a(d.body).addClass(this.classes.print.body), "" !== c.sInfo && this.fnInfo(c.sInfo, 3e3), 
                    c.sMessage && a("<div/>").addClass(this.classes.print.message).html(c.sMessage).prependTo("body"), 
                    this.s.print.saveScroll = a(b).scrollTop(), b.scrollTo(0, 0), a(d).bind("keydown.DTTT", function(a) {
                ...
                _fnPrintEnd: function(c) {
                    ...
                    this.dom.print;
                    this._fnPrintShowNodes(), ("" !== e.oScroll.sX || "" !== e.oScroll.sY) && (a(this.s.dt.nTable).unbind("draw.DTTT_Print"), 
                    this._fnPrintScrollEnd()), b.scrollTo(0, f.saveScroll), a("div." + this.classes.print.message).remove(), 
                    a(d.body).removeClass("DTTT_Print"), e._iDisplayStart = f.saveStart, e._iDisplayLength = f.saveLength, 
                    e.oApi._fnCalculateEnd && e.oApi._fnCalculateEnd(e), e.oApi._fnDraw(e), a(d).unbind("keydown.DTTT");
                },
                _fnPrintScrollStart: function() {
                    var b, c, d = this.s.dt, e = d.nScrollHead.getElementsByTagName("div")[0], f = (e.getElementsByTagName("table")[0], 
                    d.nTable.parentNode);
                    b = d.nTable.getElementsByTagName("thead"), b.length > 0 && d.nTable.removeChild(b[0]), 
                    null !== d.nTFoot && (c = d.nTable.getElementsByTagName("tfoot"), c.length > 0 && d.nTable.removeChild(c[0])), 
                    b = d.nTHead.cloneNode(!0), d.nTable.insertBefore(b, d.nTable.childNodes[0]), null !== d.nTFoot && (c = d.nTFoot.cloneNode(!0), 
                    d.nTable.insertBefore(c, d.nTable.childNodes[1])), "" !== d.oScroll.sX && (d.nTable.style.width = a(d.nTable).outerWidth() + "px", 
                    f.style.width = a(d.nTable).outerWidth() + "px", f.style.overflow = "visible"), 
            ...
            }, TableTools.defaults = TableTools.DEFAULTS, TableTools.prototype.CLASS = "TableTools", 
            TableTools.version = "2.2.4", a.fn.dataTable.Api && a.fn.dataTable.Api.register("tabletools()", function() {
                var a = null;
                return this.context.length > 0 && (a = TableTools.fnGetInstance(this.context[0].nTable)), 
                a;
        ...
        d.fn.dataTable.TableTools = TableTools, d.fn.DataTable.TableTools = TableTools, 
        TableTools;
    };
