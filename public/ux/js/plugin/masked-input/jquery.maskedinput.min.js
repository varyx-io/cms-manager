    ...
    a.mask = {
        ...
        mask: function(b, e) {
            ...
            return !b && this.length > 0 ? (h = a(this[0]), h.data(a.mask.dataName)()) : (e = a.extend({
                ...
                function q(a) {
                    var b, c, d, e = a.which;
                    8 === e || 46 === e || f && 127 === e ? (b = v.caret(), c = b.begin, d = b.end, 
                    d - c === 0 && (c = 46 !== e ? n(c) : d = h(c - 1), d = 46 === e ? h(d) : d), s(c, d), 
                    o(c, d - 1), a.preventDefault()) : 27 == e && (v.val(x), v.caret(0, u()), a.preventDefault());
                }
                function r(b) {
                    var c, d, f, i = b.which, k = v.caret();
                    b.ctrlKey || b.altKey || b.metaKey || 32 > i || i && (k.end - k.begin !== 0 && (s(k.begin, k.end), 
                    o(k.begin, k.end - 1)), c = h(k.begin - 1), m > c && (d = String.fromCharCode(i), 
                    j[c].test(d) && (p(c), w[c] = d, t(), f = h(c), g ? setTimeout(a.proxy(a.fn.caret, v, f), 0) : v.caret(f), 
                    e.completed && f >= m && e.completed.call(v))), b.preventDefault());
                }
                function s(a, b) {
                    var c;
                ...
                function u(a) {
                    ...
                    return a ? t() : k > f + 1 ? (v.val(""), s(0, m)) : (t(), v.val(v.val().substring(0, f + 1))), 
                    k ? b : l;
                }
                var v = a(this), w = a.map(b.split(""), function(a, b) {
