!function(a) {
    ...
    function b(b, c) {
        ...
        this.$element.after(this.$container), this.build(c);
    }
    function c(a, b) {
    ...
    b.prototype = {
            ...
            if (!(d.options.maxTags && d.itemsArray.length >= d.options.maxTags) && (b === !1 || b)) {
                ...
                if (!b.toString().match(/^\s*$/)) {
                    ...
                    if (k) {
                        ...
                        c || d.pushVal(), d.options.maxTags === d.itemsArray.length && d.$container.addClass("bootstrap-tagsinput-max"), 
        ...
        remove: function(b, c) {
            ...
            d.objectItems && (b = "object" == typeof b ? a.grep(d.itemsArray, function(a) {
                ...
                return a(this).data("item") === b;
            }).remove(), d.itemsArray.splice(a.inArray(b, d.itemsArray), 1)), c || d.pushVal(), 
        ...
        build: function(b) {
            ...
            e.objectItems && (e.options.freeInput = !1), c(e.options, "itemValue"), c(e.options, "itemText"), 
            c(e.options, "tagClass"), e.options.source && (h.source = e.options.source), h.source && a.fn.typeahead && (d(h, "source"), 
            e.$input.typeahead({
                source: function(b, c) {
                    function d(a) {
        ...
        return this.each(function() {
            ...
            if (f) {
                var g = f[c](d);
                void 0 !== g && e.push(g);
            } else f = new b(this, c), a(this).data("tagsinput", f), e.push(f), "SELECT" === this.tagName && a("option", a(this)).attr("selected", "selected"), 
