(function() {
    ...
    a = jQuery, a.fn.extend({
        rowslide: function(b) {
            var c, d, e;
            return c = this, d = this.find("td"), $row_id = c.attr("id"), e = this.getTallestTd(d), 
            c.animate({
                opacity: 0
            }, 80, function() {
                var f, g;
                ...
                }), f = a(e), g = a("<div/>"), g.css(f.css("padding")), f.css("padding", "0"), f.wrapInner(g), 
                f.children("div").animate({
                    height: "hide"
                }, 100, "swing", function() {
