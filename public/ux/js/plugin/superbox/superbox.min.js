    ...
    a.fn.SuperBox = function(b) {
        ...
        return this.each(function() {
            a(".superbox-list").click(function() {
                ...
                c.toggle()) : (c.insertAfter(this).css("display", "block"), $this.addClass("active")), 
                a("html, body").animate({
