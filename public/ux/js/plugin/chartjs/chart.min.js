(function() {
    ...
    var d = c.helpers = {}, e = d.each = function(a, b, c) {
        ...
        easeInElastic: function(a) {
            ...
            b = c / 4) : b = c / (2 * Math.PI) * Math.asin(1 / d), -(d * Math.pow(2, 10 * (a -= 1)) * Math.sin((1 * a - b) * (2 * Math.PI) / c)));
        },
        easeOutElastic: function(a) {
            var b = 1.70158, c = 0, d = 1;
            return 0 === a ? 0 : 1 == (a /= 1) ? 1 : (c || (c = .3), d < Math.abs(1) ? (d = 1, 
            b = c / 4) : b = c / (2 * Math.PI) * Math.asin(1 / d), d * Math.pow(2, -10 * a) * Math.sin((1 * a - b) * (2 * Math.PI) / c) + 1);
        },
        easeInOutElastic: function(a) {
            var b = 1.70158, c = 0, d = 1;
            return 0 === a ? 0 : 2 == (a /= .5) ? 1 : (c || (c = 1 * (.3 * 1.5)), d < Math.abs(1) ? (d = 1, 
            b = c / 4) : b = c / (2 * Math.PI) * Math.asin(1 / d), 1 > a ? -.5 * (d * Math.pow(2, 10 * (a -= 1)) * Math.sin((1 * a - b) * (2 * Math.PI) / c)) : d * Math.pow(2, -10 * (a -= 1)) * Math.sin((1 * a - b) * (2 * Math.PI) / c) * .5 + 1);
        },
                ...
                a.length > 0) if (this.datasets && this.datasets.length > 1) {
                    ...
                    var k = [], l = [], m = function(a) {
                        ...
                        return d.each(this.datasets, function(a) {
                            ...
                            j.push(a.x), m.push(a.y), k.push(d.template(this.options.multiTooltipTemplate, a)), 
                            l.push({
            ...
            if (this.display) {
                ...
                if (e(this.yLabels, function(b, c) {
                    ...
                    for (var b = this.valuesCount - 1; b >= 0; b--) {
                        ...
                        0 === b ? a.textAlign = "center" : b === g ? a.textAlign = "center" : g > b ? a.textAlign = "left" : a.textAlign = "right", 
                        j ? a.textBaseline = "middle" : i ? a.textBaseline = "bottom" : a.textBaseline = "top", 
