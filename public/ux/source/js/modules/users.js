$(document).ready(function() {
	if ($('.page_users').length) {
		...
		function previewUpdate(data) {
			...
			user.find('.users-preview__detail').attr('href', '/users/' + data[0]);
			user.find('.users-preview__reset').attr('href', '/users/' + data[0] + '/reset');
			user.find('.users-preview__disable').attr('href', '/users/' + data[0] + '/disable');
			user.find('.users-preview__delete').attr('href', '/users/' + data[0] + '/delete');
